...
\titlecontents{chapter}[2em]{\vspace{.5\baselineskip}\xiaosan\hei}
             {\thecontentslabel\song\quad}{}
             {\hspace{.5em}\titlerule*[5pt]{$\cdot$}\sihao\contentspage}
\titlecontents{section}[4.7em]{\vspace{.25\baselineskip}\sihao\hei}
             {\thecontentslabel\song\quad}{}
             {\hspace{.5em}\titlerule*[5pt]{$\cdot$}\sihao\contentspage}
\titlecontents{subsection}[6.2em]{\vspace{.25\baselineskip}\sihao\hei}
             {\thecontentslabel\song\quad}{}
             {\hspace{.5em}\titlerule*[5pt]{$\cdot$}\sihao\contentspage}
   ...
   \phantomsection
    ...
    \begin{titlepage}
      ...
      \begin{figure}[h]
      	...
      	\includegraphics[width=0.2\textwidth]{figures/ustblogo.png}
      \end{figure}
      \begin{center}
		\vspace*{60pt}
	  \yahei\erhao{\textbf{北$\quad$京$\quad$科$\quad$技$\quad$大$\quad$学}}
	  \vspace*{15pt}
	 ...
	 \vspace*{15pt}
	  ...
	  \begin{tabular}{cc}
	    ...
	    姓\qquad 名: &  \makebox[\@title@width][l]{\@cauthor} \\%\underline{\makebox[\@title@width][c]{\@cauthor}}
	    学\qquad 号: &  \makebox[\@title@width][l]{\@cnumber} \\
	    专业班级: &  \makebox[\@title@width][l]{\@csubject} \\
	...
	\end{center}
	\vspace*{120pt}
	\rightline{\song\xiaosi{\textbf{撰写日期：}}}
	\rightline{\@cdate}
\end{titlepage}
...
%% \chapter*{\centering\erhao\song\textbf{ 摘\quad 要}}
%\chapter*{\centering\erhao\bfsong{ 摘\quad 要}}
%\song\defaultfont
%\@cabstract
%\vspace{\baselineskip}
%
